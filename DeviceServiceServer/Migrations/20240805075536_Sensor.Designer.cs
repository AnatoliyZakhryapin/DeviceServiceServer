...
{
    [DbContext(typeof(DeviceServiceServerContext))]
    [Migration("20240805075536_Sensor")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DeviceServiceServer.Models.Sensor", b =>
                {
                    ...
                    b.HasIndex("SensorSerialNumber")
                        .IsUnique();

                    b.ToTable("Sensors");
                });

            modelBuilder.Entity("DeviceServiceServer.Models.SensorData", b =>
                {
            ...
            modelBuilder.Entity("DeviceServiceServer.Models.SensorData", b =>
                {
                    b.HasOne("DeviceServiceServer.Models.Sensor", "Sensor")
                        .WithMany("SensorData")
